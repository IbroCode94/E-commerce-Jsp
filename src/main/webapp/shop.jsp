<%@ page import="static DAO.AdminDAO.getAllProducts" %>
          ...
          <div class="container p-0">
            <div class="row">
              ...
              <div class="col-lg-9 order-1 order-lg-2 mb-5 mb-lg-0">
                ...
                <div class="row">
                  <!-- PRODUCT-->
                  <% for (Products list: getAllProducts()
                          ) {
                  ...
                  <div class="col-lg-4 col-sm-6">
                    <div class="product text-center">
                      <div class="mb-3 position-relative">
                        <div class="badge text-white bg-"></div><a class="d-block" href="detail.jsp"><img class="img-fluid w-100" src="img/<%= list.getImage()%>"></a>
                        <div class="product-overlay">
                          <ul class="mb-0 list-inline">
                            <li class="list-inline-item m-0 p-0"><a class="btn btn-sm btn-outline-dark" href="#!"><i class="far fa-heart"></i></a></li>
                            <li class="list-inline-item m-0 p-0"><a class="btn btn-sm btn-dark" href="register.jsp">Add to cart</a>
                      ...
                      <h6> <a class="reset-anchor" href="detail.jsp"><%= list.getProdName()%></a></h6>
                      <p class="small text-muted"><%= list.getPrice()%></p>
                    </div>
                  </div>
                    ...
                    <div class="product text-center">
                      <div class="mb-3 position-relative">
                        ...
                        <div class="product-overlay">
                          <ul class="mb-0 list-inline">
                            <li class="list-inline-item m-0 p-0"><a class="btn btn-sm btn-outline-dark" href="#!"><i class="far fa-heart"></i></a></li>
                            <li class="list-inline-item m-0 p-0"><form action="${pageContext.request.contextPath}/AddCartServlet" method="post">
                              <label for="hide<%=list.getProd_Id()%>"><a class="btn btn-sm btn-dark">Add to cart</a></label>
                              <input type="hidden" value="<%= session.getAttribute("id")%>" name="user_id">
                              <input type="hidden" value="<%=list.getProd_Id()%>" name="product_id">
                            <button type="submit" style="display:none" id="hide<%=list.getProd_Id()%>"></button> </form></li>
                            <li class="list-inline-item mr-0"><a class="btn btn-sm btn-outline-dark" href="#productView" data-bs-toggle="modal"><i class="fas fa-expand"></i></a></li>
                          </ul>
                        </div>
                      </div>
