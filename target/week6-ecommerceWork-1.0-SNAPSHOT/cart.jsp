...
<%@ page import="static DAO.UserDAO.getAllProductid" %>
...
<html>
  ...
  String ids=session.getAttribute("id").toString();
    ...
    for (Cart cart: getAllCartid(ids)) {


%>
                    <tr>
                      <% double total=0;
                        for (Products products : getAllProductid(cart.getProduct_id())) {
                      %>

                      <th class="ps-0 py-3 border-0" scope="row">
                        <div class="d-flex align-items-center"><a class="reset-anchor d-block animsition-link" href="detail.jsp"><img src="img/<%= products.getImage()%>" alt="..." width="70"/></a>
                          <div class="ms-3"><strong class="h6"><a class="reset-anchor animsition-link" href="detail.jsp"><%= products.getProdName()%></a></strong></div>
                        </div>
                      </th>
                      <td class="p-3 align-middle border-0">
                        <p class="mb-0 small"><%=products.getPrice()%></p>
                      </td>
                      <td class="p-3 align-middle border-0">
...
%>
              ...
              <div class="bg-light px-4 py-3">
                <div class="row align-items-center text-center">
                  <div class="col-md-6 mb-3 mb-md-0 text-md-start"><a class="btn btn-link p-0 text-dark btn-sm" href="shop.jsp"><i class="fas fa-long-arrow-alt-left me-2"> </i>Continue shopping</a></div>
                  <div class="col-md-6 text-md-end"><a class="btn btn-outline-dark btn-sm" href="checkout.jsp">Procceed to checkout<i class="fas fa-long-arrow-alt-right ms-2"></i></a></div>
                </div>
              </div>
            </div>
            <!-- ORDER TOTAL-->
