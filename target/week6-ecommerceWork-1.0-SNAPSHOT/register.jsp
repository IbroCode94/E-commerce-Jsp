...
<div id="app" class="app-main display justify-content align-items flex-direction">
    ...
    <div class="wi-100 app display justify-content align-items">
        ...
        <form action="${pageContext.request.contextPath}/RegistrationServlet" method="POST" id="signup" class="login-form flex-direction display justify-content">
        ...
        <form action="${pageContext.request.contextPath}/LoginServlet" method="post" id="login" class="login-form flex-direction display justify-content" style="display:none">
            <div class="wi-100 display he-100 display justify-space-around">
                <img src="https://salespoint.com.ng/app/images/logo.png" width="100" />
